...
<script>
  export default {
    ...
    beforeCreate () {
      this.axios.axiosget({
        url:'/portal/announcement/detailsPost',
        params:{
        ...
        this.time = this.DefaultJs.getTime(ret.data.data.release_time).formatting
...
<style lang="less" scoped>
  .h5announcement{background: #fff;overflow:hidden;min-height:100%;
    ...
    div.box{width:100%;margin:0 auto;overflow: hidden;padding:0 .6rem;box-sizing:border-box;background:#fff;;
      ...
      p.times{margin-bottom:.3rem;display: block;color:#caccd1;font-size:.24rem;text-align: center;display: block;;}
